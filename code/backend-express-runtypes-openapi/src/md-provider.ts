...
import type * as state from "@ty-ras/state-runtypes";
import * as mdOpenAPI from "@ty-ras/metadata-openapi";
import * as mdJsonSchema from "@ty-ras/metadata-jsonschema-runtypes";
...
/**
 * This type encapsulates all necessary information for creating OpenAPI metadata provider able to auto-parse `runtypes` encoders and decoders into JSON schema.
 */
