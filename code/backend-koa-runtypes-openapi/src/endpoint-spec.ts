...
import * as dataValidation from "@ty-ras/data-runtypes";
import type * as md from "@ty-ras/metadata-openapi";
import * as stateGeneric from "@ty-ras/state";
import * as state from "@ty-ras/state-runtypes";
import * as dataIO from "@ty-ras/data-backend-runtypes";
import * as jsonIO from "@ty-ras/metadata-jsonschema-runtypes";
import * as mdProvider from "./md-provider";
import type * as server from "@ty-ras/server-koa";
...
/**
 * This is type for base constraints of generic parameters representing state specification objects with `runtypes` validators.
 */
export type TStateSpecBase = Readonly<Record<string, t.Runtype>>;
...
> {
   ...
   * The keys are property names, and values are `runtypes` validators.
   */
  ...
  /**
   * The callback to get fallback JSON schema value whenever the built-in transformation from `runtypes` validators to JSON schema objects fails.
   */
  getJsonSchemaFallback: jsonIO.FallbackValue;

  /**
   * The callback to get override value for JSON schema whenever built-in transformation from `runtypes` validators to JSON schema objects is needed to be skipped.
   */
